...
internal static class ContextDiffCopy
{
    ...
    private static readonly (string Name, byte[] Base, Func<byte[], byte[]> Commit, Func<byte[], byte[]> Local)[] Cases =
    [
        ("plain.txt", Lines(40), t => Replaced(Replaced(t, "line 5\n", "line five\n"), "line 30\n", "line thirty\n"), t => Replaced(Replaced(t, "line five\n", "line 5 again\n"), "line 38\n", "line thirty-eight\n")),
        ("gap5.txt", Lines(40), t => Replaced(Replaced(t, "line 10\n", "line ten\n"), "line 16\n", "line sixteen\n"), t => Replaced(Replaced(t, "line 11\n", "line eleven\n"), "line 17\n", "line seventeen\n")),
        ("gap6.txt", Lines(40), t => Replaced(Replaced(t, "line 10\n", "line ten\n"), "line 17\n", "line seventeen\n"), t => Replaced(Replaced(t, "line 11\n", "line eleven\n"), "line 18\n", "line eighteen\n")),
        ("crlf-noprop.txt", Lines(12, "\r\n"), t => Replaced(t, "line 6\r\n", "line six\r\n"), t => Replaced(t, "line 7\r\n", "line seven\r\n")),
        ("mixed-noprop.txt", Lines(12), t => Replaced(t, "line 6\n", "line six\r\n"), t => Replaced(t, "line 3\n", "line three\r\n")),
        ("eol-only.txt", Lines(6), t => Replaced(t, "line 2\n", "line 2\r\n"), t => Replaced(t, "line 4\n", "line 4\r\n")),
        ("lone-cr.txt", "a\rb\nc\nd\n"u8.ToArray(), t => Replaced(t, "b\n", "B\n"), t => Replaced(t, "c\n", "C\n")),
        ("native.txt", Lines(12), t => Replaced(t, "line 6", "line six"), t => Replaced(t, "line 7", "line seven")),
        ("lf-style.txt", Lines(12), t => Replaced(t, "line 6\n", "line six\n"), t => Replaced(t, "line 7\n", "line seven\n")),
        ("crlf-style.txt", Lines(12), t => Replaced(t, "line 6", "line six"), t => Replaced(t, "line 7", "line seven")),
        ("cr-style.txt", Lines(12), t => Replaced(t, "line 6", "line six"), t => Replaced(t, "line 7", "line seven")),
        ("native-lf-on-disk.txt", Lines(12), t => Replaced(t, "line 6", "line six"), t => Replaced(Encoding.ASCII.GetBytes(Encoding.ASCII.GetString(t).Replace("\r\n", "\n", StringComparison.Ordinal)), "line 7", "line seven")),
        ("text-mime.txt", Lines(12), t => Replaced(t, "line 6\n", "line six\n"), t => Replaced(t, "line 7\n", "line seven\n")),
        ("html-mime.txt", "<p>1</p>\n<p>2</p>\n"u8.ToArray(), t => Replaced(t, "<p>2</p>", "<p>two</p>"), t => Replaced(t, "<p>1</p>", "<p>one</p>")),
        ("empty.txt", [], _ => Lines(2), _ => Lines(1)),
        ("becomes-empty.txt", Lines(3), _ => [], _ => Lines(2)),
        ("no-eol.txt", "one\ntwo\nthree"u8.ToArray(), _ => "one\ntwo\nTHREE"u8.ToArray(), _ => "one\ntwo\nTHREE\nfour"u8.ToArray()),
        ("gains-no-eol.txt", "one\ntwo\nthree\n"u8.ToArray(), _ => "one\ntwo\nthree"u8.ToArray(), _ => "one\ntwo\nthree\n"u8.ToArray()),
        ("no-eol-context.txt", "a\nb\nc\nd"u8.ToArray(), _ => "a\nB\nc\nd"u8.ToArray(), _ => "A\nB\nc\nd"u8.ToArray()),
        ("ambiguous.txt", "a\nb\nc\na\nb\nc\n"u8.ToArray(), t => [.. t, .. "x\n"u8], _ => "a\nb\nc\nx\na\nb\nc\na\nb\nc\nx\n"u8.ToArray()),
        ("swap.txt", "1\n2\n3\n4\n5\n6\n7\n8\n"u8.ToArray(), _ => "5\n6\n7\n8\n1\n2\n3\n4\n"u8.ToArray(), _ => "1\n2\n3\n4\n5\n6\n7\n8\n"u8.ToArray()),
        ("brace.txt", "f() {\n  a;\n}\n\ng() {\n  b;\n}\n"u8.ToArray(), _ => "f() {\n  a;\n}\n\nh() {\n  c;\n}\n\ng() {\n  b;\n}\n"u8.ToArray(), _ => "f() {\n  a;\n}\n\ng() {\n  b;\n}\n"u8.ToArray()),
        ("keywords.txt", "top\n$Id$\nmid\nend\n"u8.ToArray(), t => Replaced(t, "end\n", "END\n"), t => Replaced(t, "mid\n", "MID\n")),
        ("binary.dat", "a\0b\0c\n"u8.ToArray(), _ => "a\0B\0c\n"u8.ToArray(), _ => "a\0B\0C\n"u8.ToArray()),
        ("binary-no-mime.dat", "x\0y\n"u8.ToArray(), _ => "x\0Y\n"u8.ToArray(), _ => "x\0Z\n"u8.ToArray()),
        ("props.txt", Lines(5), t => t, t => t),
        ("props-and-text.txt", Lines(5), t => Replaced(t, "line 2\n", "line two\n"), t => Replaced(t, "line 3\n", "line three\n")),
    ...
    private static SvnWorkingCopy Build()
    {
        ...
        copy.Svn("propset", "--quiet", "svn:eol-style", "native", "native.txt", "native-lf-on-disk.txt");
