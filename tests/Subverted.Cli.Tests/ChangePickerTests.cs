...
public sealed class ChangePickerTests
{
    ...
    {
        var picker = new ChangePicker([File("src/a.txt"), File("src/b.txt")], Sensitive);
    ...
    {
        var picker = new ChangePicker([File("src/a.txt")], Sensitive);
    ...
    )
    {
        var picker = new ChangePicker(
            [Directory("fresh", NodeStatus.Added), Added("FRESH/n.txt")],
            comparison
        );
    ...
    {
        var picker = new ChangePicker(candidates, Sensitive);
